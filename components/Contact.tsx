...
const contacts: ContactBlock[] = [
  {
    icon: Mail,
    label: "E-Mail",
    value: "info@niumedia.de",
    href: "mailto:info@niumedia.de",
  },
  {
    icon: MessageCircle,
    label: "WhatsApp",
  ...
  },
  {
    ...
    label: "Instagram",
    value: "@niu.media",
    href: "https://instagram.com/niu.media",
  },
];
        ...
        >
          {contacts.map((contact) => (
            <motion.a
              ...
              className="group flex items-center justify-between bg-background border border-border hover:border-accent/40 p-7 transition-colors duration-300"
            >
              <div className="flex items-start gap-5">
                ...
                />
                <div>
                  <p className="text-xs text-foreground/50 font-semibold tracking-widest uppercase mb-1.5">
                    {contact.label}
                  </p>
              ...
              <ArrowRight
                size={16}
                className="text-foreground/30 group-hover:text-accent group-hover:translate-x-1 transition-all duration-300 shrink-0"
                aria-hidden="true"
              />
            </motion.a>
          ))}
